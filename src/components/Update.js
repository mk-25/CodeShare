...
function Update() {
  ...
  useEffect(()=>{
    ...
    const fetchData = async ()=>{
      const res = await axios.get(`https://stormy-newt-getup.cyclic.cloud//api/posts/${id}`)
  ...
  const handleSubmit =async (e)=>{
    ...
    toggleProcess()
    const res = await axios.patch(`https://stormy-newt-getup.cyclic.cloud//api/posts/${id}`,{title,description:des,code,author,tags:array,email})
    toggleProcess()
